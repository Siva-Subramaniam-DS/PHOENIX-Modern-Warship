...
To allow the PHOENIX Modern Warship bot to read and write to your Google Sheets, you need to set up a **Google Service Account**. Follow these steps carefully.

## Step 1: Create a Google Cloud Project
1. Go to the [Google Cloud Console](https://console.cloud.google.com/).
2. Click on the project dropdown at the top left and select **"New Project"**.
3. Name your project (e.g., "PHOENIX Modern Warship Bot") and click **Create**.
...
3. **Service account details**:
   - Name: `phoenix-modern-warship-bot` (or anything you like).
...
2. Look for the `"client_email"` field (e.g., `phoenix-modern-warship-bot@your-project.iam.gserviceaccount.com`).
